## Gaurav Sonawane B-47   # Date : 11-09-2022
'''
...
(NOTE : Duplicate entries should be avoided. Do not use SET built-in functions)
'''
...
for i in range(0, n):
    a = input()
    Cricket.append(a)  # adding the element
...
for i in range(0, n):
    a = input()
    Football.append(a)  # adding the element
...
for i in range(0, n):
    a = input()
    Badminton.append(a)  # adding the element
...
while flag==1:
    ...
    if ch==1:
        ...
        print("Number of students who play either cricket or badminton but not both : ", eCoB(Cricket, Badminton))
        a = input("\n\nDo you want to continue (yes/no) :")
        if a == "yes":
            flag = 1
        else:
        ...
        if a=="yes":
            ...
            flag=0
            print("This is your stepping stone to DSL.Thank u!!!!")
